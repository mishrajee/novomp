 ...
 */
public class GridMusicAdapter extends BaseAdapter {
    ...
    public GridMusicAdapter(Context context, List<Collection1> collection) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            view = layoutInflater.inflate(R.layout.music_grid,parent,false);

            viewHolder = new ViewHolder();

            viewHolder.albumImageView = (ImageView) view.findViewById(R.id.grid_image);
            viewHolder.artistTextView = (TextView) view.findViewById(R.id.grid_artist);
            viewHolder.songTextView = (TextView) view.findViewById(R.id.grid_song);
